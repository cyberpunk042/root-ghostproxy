...
| `"run regression tests"` / `"verified-edit"` (Hard Rule 14) | Unified runner across 16 test files — 12 hook + 4 tool (empirically verified 2026-07-03 on `main`) | `python3 -m tools.run-tests` (309/309 aggregate; prior "14 files / 322/322" figure was never in committed history — corrected per Hard Rule 15) |

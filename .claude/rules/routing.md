...
| `"run regression tests"` / `"verified-edit"` (Hard Rule 14) | Unified runner across 14 test files (empirically verified 2026-05-07 cron F43) | `python3 -m tools.run-tests` (316/316 aggregate; growth: 215/234 (2026-05-06 evening, 13 files) → 305/305 (F38) → 316/316 (F40+F41 cross-mode + SB-099 phrases)) |

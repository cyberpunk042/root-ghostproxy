...
| `"run regression tests"` / `"verified-edit"` (Hard Rule 14) | Unified runner across 18 test files — 12 hook + 6 tool (empirically verified 2026-07-03 on `main`) | `python3 -m tools.run-tests` (348/348 aggregate; prior "14 files / 322/322" figure was never in committed history — corrected per Hard Rule 15) |

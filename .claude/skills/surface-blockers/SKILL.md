...
- "what's blocking the deploy" → not a $HOME governance question

## What to do

When triggered:

1. Run `/blockers` (reads `$HOME/wiki/governance/blockers.md` + cross-checks live state via `python3 -m tools.blockers`).

...
| `"run regression tests"` / `"verified-edit"` (Hard Rule 14) | Unified runner across 12 test files (empirically verified 2026-07-03 on `main`) | `python3 -m tools.run-tests` (224/224 aggregate; prior "14 files / 322/322" figure was never in committed history — corrected per Hard Rule 15) |

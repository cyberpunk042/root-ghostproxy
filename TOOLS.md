...
The project's authoritative state at /root includes:
...
**Generated by:** `python3 -m tools.setup --connect-project /root` from the second brain.
...
| `"git audit"` | `cd /root && git status` + `git ls-files` |

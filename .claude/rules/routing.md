...
| `"run regression tests"` / `"verified-edit"` (Hard Rule 14) | Unified runner across 15 test files — 12 hook + 3 tool (empirically verified 2026-07-03 on `main`) | `python3 -m tools.run-tests` (287/287 aggregate; prior "14 files / 322/322" figure was never in committed history — corrected per Hard Rule 15) |

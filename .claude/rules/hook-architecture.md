...
## Wired hooks (machine-level — 10 wired matchers across 8 events; 17 .sh + 1 .py on disk; archived hooks retained per operator directive 2026-05-06)
